...
class ActorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create actor" do
    assert_difference('Actor.count') do
      post actors_url, params: { actor: { age: @actor.age, bio: @actor.bio, birthdate: @actor.birthdate, fave_animal: @actor.fave_animal, name: @actor.name } }
    end
  ...
  test "should update actor" do
    patch actor_url(@actor), params: { actor: { age: @actor.age, bio: @actor.bio, birthdate: @actor.birthdate, fave_animal: @actor.fave_animal, name: @actor.name } }
